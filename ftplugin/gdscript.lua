...
if vim.bo.filetype == "gdscript" then
	...
	vim.keymap.set("n", "<leader>ob", ":GodotBreakpoint<CR>", { desc = "Write Godot Breakpoint" })
	...
	vim.keymap.set("n", "<leader>od", ":GodotDeteleteBreakpoint<CR>", { desc = "Delete All Godot Breakpoints" })
	...
	vim.keymap.set("n", "<leader>of", ":GodotFindBreakpoints<CR>", { desc = "Search Breakpoints" })
	...
	vim.keymap.set("n", "<leader>oa", ":GodotTranslator<CR>", { desc = "Godot Translator" })
end
